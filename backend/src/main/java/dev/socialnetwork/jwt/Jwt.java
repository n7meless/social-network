...
public class Jwt {
    ...
    private Jwt(String token, LocalDateTime issueAt, LocalDateTime expiration, Long accountId) {
        this.token = token;
    ...
    public static Jwt of(Long accountId, Long validityInMinutes, String secretKey) {
